...
public class EcommerceAPITest {
	...
	loginRequest.setUserEmail("restapi@test.com");
	loginRequest.setUserPassword("Abhi7196$");
	...
	RequestSpecification reqAddProduct = given()
			...
			.param("productName", "Ajio")
			.param("productAddedBy", userId)
			.param("productCategory", "fashion")
			.param("productSubCategory", "shirts")
			.param("productPrice", "11500")
			.param("productDescription", "Branded T-Shirts")
			.param("productFor", "men")
			.multiPart("productImage",new File("/Users/abinayamurali/Downloads/Blue_Tshirt.jpg"));
